...
{
    /// <inheritdoc />
    public partial class SeedDataInitialization : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateFacturation = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LignesCommande_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LignesCommande_ProductId",
                table: "LignesCommande",
                column: "ProductId");
        }
